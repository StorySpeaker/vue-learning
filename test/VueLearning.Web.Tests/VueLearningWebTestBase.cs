...
{
    public abstract class VueLearningWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static VueLearningWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(VueLearningWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<VueLearningDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<VueLearningDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<VueLearningDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<VueLearningDbContext, Task<T>> func)
        {
            T result;
