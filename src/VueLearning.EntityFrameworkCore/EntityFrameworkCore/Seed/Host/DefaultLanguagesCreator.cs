...
namespace VueLearning.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly VueLearningDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = VueLearningConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(VueLearningDbContext context)
        {
            _context = context;
        }
